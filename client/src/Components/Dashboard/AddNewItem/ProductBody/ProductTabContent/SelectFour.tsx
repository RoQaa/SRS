...
const SelectFour = () => {
  ...
  return (
    <Col sm="6">
      <Row>
        <Col xs="12">
          <Label for="validationServer01" check>Publish<span className="txt-danger"> *</span></Label>
          <Input type="select" name="published" onChange={(e)=>handleStatus(e.target.value)}>
