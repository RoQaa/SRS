...
// News
export const AllNews = `All`;
export const PublishedNews = `Published`;
export const UnPublishedNews = `UnPublished`;
export const CreateNews = `Create New News`;
export const NewsTitle = `News Title (English)`;
export const NewsCONTENT = `News Content (English)`;
export const NewsTitle_AR = `News Title (Arabic)`;
export const NewsCONTENT_AR = `News Content (Arabic)`;
