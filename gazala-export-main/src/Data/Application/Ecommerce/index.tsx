...
import {
  ...
  ProductListTableDataColumnType,
  ProductListTableProduct,
} from "@/Types/EcommerceType";
...
const OrderHistoryImage: React.FC<OrderHistoryImageType> = ({ name }) => {
  return (
    <img
      className="img-fluid img-30 my-3 rounded-3"
      src={`${ImagePath}/product/${name}`}
      alt="#"
    />
  );
};
...
export const OrderHistoryDataColumn = [
  {
    ...
    cell: (row: OrderHistoryTableColumns) => (
      <OrderHistoryImage name={row.image} />
    ),
    center: true,
  },
  {
    name: "Product Name",
    cell: (row: OrderHistoryTableColumns) => (
      <OrderDataHistory name={row.productName} tag={row.tag} />
    ),
    sortable: true,
    center: true,
  },
...
const ProductListTableProductName: React.FC<ProductListTableProduct> = ({
  images,
  name,
}) => {
  return (
...
const ProductListTableStatus: React.FC<ProductListTableProduct> = ({
  name,
}) => {
  return (
    <Badge
...
const ProductListTableRating: React.FC<ProductListTableProduct> = ({
  rate,
}) => {
...
export const ProductListTableDataColumn = [
  ...
  },
  {
    name: "Status",
    cell: (row: ProductListTableDataColumnType) => (
      <ProductListTableStatus name={row.status} />
    ),
  },
  {
    name: "Rating",
    cell: (row: ProductListTableDataColumnType) => (
      <ProductListTableRating rate={row.rating} />
    ),
  },
  {
    name: "Action",
...
// NEWS LEFT-SIDE-BAR
export const AddNewsNav = [
  {
    id: 1,
    icon: "product-detail",
    title: "Add News Details",
    detail: "Add News title & details",
  },
  {
    id: 2,
    icon: "product-detail",
    title: "Add Arabic News Details",
    detail: "Add Arabic News title & details",
  },
  {
    id: 3,
    icon: "product-gallery",
    title: "Add Files",
    detail: "Upload related files",
  },
  {
    id: 4,
    icon: "product-category",
    title: "Status & Date",
    detail: "Set news status and date",
  },
];

// EDIT NEWS LEFT-SIDE-BAR
export const editNewsNav = [
  {
    id: 1,
    icon: "product-detail",
    title: "Edit News",
    detail: "Edit News title & details",
  },
  {
    id: 2,
    icon: "product-detail",
    title: "Edit Arabic News Details",
    detail: "Edit Arabic News title & details",
  },
  {
    id: 3,
    icon: "product-gallery",
  ...
  },
  {
    ...
    icon: "product-category",
    title: "Status & Date",
    detail: "update news status and date",
  },
];

// SCOPE LEFT-SIDE-BAR
export const AddScopeNav = [
  {
    id: 1,
    icon: "product-detail",
    title: "Add Scope Details",
    detail: "Add Scope Service & details",
  },
  {
    id: 2,
    icon: "product-detail",
    title: "Add Arabic Scope Details",
    detail: "Add Arabic Scope Service & details",
  },
  {
    id: 3,
    icon: "product-gallery",
  ...
  },
  {
    ...
    icon: "product-category",
    title: "Status",
    detail: "Set scope status",
  },
];

// Edit SCOPE LEFT-SIDE-BAR
export const EditScopeNav = [
  {
    id: 1,
    icon: "product-detail",
    title: "Edit Scope Details",
    detail: "Edit Scope Service & details",
  },
  {
    id: 2,
    icon: "product-detail",
    title: "Edit Arabic Scope Details",
    detail: "Edit Arabic Scope Service & details",
  },
  {
    id: 3,
    icon: "product-gallery",
